...
if os.path.isdir('hawkular-images'):
    shutil.copytree('hawkular-images',os.path.join(targetdir, 'hawkular-images'))
if os.path.isdir('mwprovider-images'):
    shutil.copytree('mwprovider-images',os.path.join(targetdir, 'mwprovider-images'))
